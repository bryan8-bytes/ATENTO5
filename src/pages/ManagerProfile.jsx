...
const ManagerProfile = () => {
  ...
  // Scroll to top on component mount - useLayoutEffect for immediate scroll
  useLayoutEffect(() => {
    window.scrollTo(0, 0);
      ...
      >
        ...
        <header style={{ display: 'flex', justifyContent: 'flex-start', alignItems: 'center', marginBottom: '32px' }}>
          ...
          >
            <div onClick={() => navigate(-1)} style={{
              ...
              background: 'linear-gradient(135deg, rgba(60, 180, 255, 0.1), rgba(210, 20, 20, 0.1))',
              border: '1px solid rgba(210, 20, 20, 0.3)',
              boxShadow: '0 0 15px rgba(60, 180, 255, 0.1), inset 0 0 10px rgba(210, 20, 20, 0.1)',
              transition: 'all 0.3s ease'
            }}
            onMouseEnter={(e) => { 
              e.currentTarget.style.background = 'linear-gradient(135deg, rgba(60, 180, 255, 0.2), rgba(210, 20, 20, 0.2))';
              e.currentTarget.style.boxShadow = '-8px 0px 20px rgba(60, 180, 255, 0.4), 8px 0px 20px rgba(210, 20, 20, 0.4)'; 
              e.currentTarget.style.borderColor = 'rgba(255, 255, 255, 0.3)';
            }}
            onMouseLeave={(e) => { 
              e.currentTarget.style.background = 'linear-gradient(135deg, rgba(60, 180, 255, 0.1), rgba(210, 20, 20, 0.1))';
              e.currentTarget.style.boxShadow = '0 0 15px rgba(60, 180, 255, 0.1), inset 0 0 10px rgba(210, 20, 20, 0.1)'; 
        ...
        <div style={{
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '30px', margin: '50px 0' }}>
            <div style={{ background: 'rgba(60, 180, 255, 0.05)', borderRadius: '16px', padding: '30px', border: '1px solid rgba(60, 180, 255, 0.15)' }}>
              <h4 style={{ display: 'flex', alignItems: 'center', gap: '12px', fontSize: '1.2rem', fontWeight: 700, color: 'white', marginBottom: '16px' }}>
                <Target color="#3CB4FF" size={24} /> Nuestra Misión
              </h4>
            ...
            <div style={{ background: 'rgba(210, 20, 20, 0.05)', borderRadius: '16px', padding: '30px', border: '1px solid rgba(210, 20, 20, 0.15)' }}>
              <h4 style={{ display: 'flex', alignItems: 'center', gap: '12px', fontSize: '1.2rem', fontWeight: 700, color: 'white', marginBottom: '16px' }}>
                <Lightbulb color="#D21414" size={24} /> Nuestra Visión
              </h4>
              <p style={{ fontSize: '0.95rem', color: 'rgba(255, 255, 255, 0.7)', lineHeight: 1.7, textAlign: 'justify' }}>

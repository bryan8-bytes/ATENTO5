...
const Contact = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    // Intento principal: PHP en servidor de producción
    try {
      ...
      // Fallback: abrir cliente de correo nativo con los datos prellenados
  ...
  const contactInfo = [{
    ...
    title: 'Correo',
    value: 'Juan.ampuero@atento5.com',
    icon: <Mail size={20} />,
      ...
      padding: '0 24px'
        ...
        marginBottom: '60px'
          ...
          duration: 0.6
            ...
            scale: 1.03,
            background: 'linear-gradient(135deg, rgba(60, 180, 255,0.05) 0%, rgba(210, 20, 20,0.05) 100%)',
            borderColor: 'rgba(255, 255, 255, 0.1)',
            boxShadow: '-5px 0px 20px rgba(60, 180, 255, 0.15), 5px 0px 20px rgba(210, 20, 20, 0.15)'
          }}>
                <div style={{
              width: '52px',
              height: '52px',
              borderRadius: '14px',
              background: index % 2 === 0 ? 'linear-gradient(135deg, rgba(60, 180, 255, 0.2), rgba(60, 180, 255, 0.05))' : 'linear-gradient(135deg, rgba(210, 20, 20, 0.2), rgba(210, 20, 20, 0.05))',
              display: 'flex',
              alignItems: 'center',
            ...
            cursor: 'pointer',
            marginTop: '8px',
            boxShadow: '0 4px 25px rgba(60, 180, 255, 0.3)'
          }} initial={{
            opacity: 0,
            y: 20
          }} whileInView={{
            ...
            <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '18px' }}>
              ...
              <AnimatePresence mode="wait">
                {status.message && (
                  ...
                  >
                    {status.success ? (
                      <CheckCircle size={18} style={{ flexShrink: 0, marginTop: '2px', color: '#4ade80' }} />
                    ) : (
              ...
              <motion.button 
                ...
                style={{
                  ...
                  boxShadow: '0 4px 20px rgba(60, 180, 255, 0.25)',
                  marginTop: '10px',
                ...
                whileHover={status.submitting ? {} : {
                  scale: 1.02,
                  boxShadow: '-10px 0px 25px rgba(60, 180, 255, 0.35), 10px 0px 25px rgba(210, 20, 20, 0.35)'
                }}
        ...
        {/* Testimonials Block: Repositioned below as a gorgeous 3-column row */}
        <motion.div 

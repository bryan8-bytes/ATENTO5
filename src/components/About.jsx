      ...
      padding: '0 24px'
        ...
        marginBottom: '80px'
          ...
          duration: 0.6
            ...
            gap: '12px'
              ...
              <span style={{
              background: 'linear-gradient(135deg, #D21414 0%, #3CB4FF 100%)',
              WebkitBackgroundClip: 'text',
              WebkitTextFillColor: 'transparent',
              backgroundClip: 'text'
            }}>
        ...
        duration: 0.6
          ...
          gap: '24px'
            ...
            scale: 1.05,
            borderColor: 'rgba(60, 180, 255, 0.5)',
            boxShadow: '0 10px 30px rgba(60, 180, 255, 0.15), 0 -10px 30px rgba(210, 20, 20, 0.15)'
          }}>
                <div style={{
              position: 'absolute',
              top: '-12px',

...
const BrochureSection = () => {
  return <section id="brochure" style={{
    ...
    overflow: 'hidden'
      ...
      width: '400px',
      height: '400px',
      background: 'radial-gradient(circle, rgba(60, 180, 255, 0.12) 0%, transparent 70%)',
      filter: 'blur(80px)',
      borderRadius: '50%'
    }} animate={{
      scale: [1, 1.2, 1],
      ...
      width: '350px',
      height: '350px',
      background: 'radial-gradient(circle, rgba(210, 20, 20, 0.1) 0%, transparent 70%)',
      filter: 'blur(70px)',
      borderRadius: '50%'
    }} animate={{
      scale: [1, 1.15, 1],
      ...
      inset: 0,
      backgroundImage: `
          linear-gradient(rgba(60, 180, 255, 0.02) 1px, transparent 1px),
          linear-gradient(90deg, rgba(60, 180, 255, 0.02) 1px, transparent 1px)
        `,
      ...
      zIndex: 10
        ...
        duration: 0.7
          ...
          fontSize: '13px',
          fontWeight: 600,
          background: 'linear-gradient(135deg, rgba(210, 20, 20, 0.15), rgba(210, 20, 20, 0.08))',
          color: '#D21414',
          border: '1px solid rgba(210, 20, 20, 0.3)',
          marginBottom: '24px',
          letterSpacing: '0.1em'
        }} animate={{
          boxShadow: ['0 0 20px rgba(210, 20, 20, 0.2)', '0 0 40px rgba(210, 20, 20, 0.4)', '0 0 20px rgba(210, 20, 20, 0.2)']
        }} transition={{
          duration: 2,
          repeat: Infinity,
          ease: 'easeInOut'
        ...
        alignItems: 'center'
          ...
          boxShadow: '0 20px 60px rgba(0, 0, 0, 0.3)'
            ...
            zIndex: 1
              ...
              height: '90px',
              borderRadius: '24px',
              background: 'linear-gradient(135deg, rgba(60, 180, 255, 0.2), rgba(6, 182, 212, 0.1))',
              display: 'flex',
              alignItems: 'center',
              justifyContent: 'center',
              marginBottom: '28px',
              border: '2px solid rgba(60, 180, 255, 0.2)'
            }}>
                <FileText size={40} color="#3CB4FF" />
              </div>
          ...
          gap: '28px'
            ...
            duration: 0.3
              ...
              position: 'absolute',
              inset: 0,
              background: 'radial-gradient(circle at 50% 50%, rgba(60, 180, 255, 0.1) 0%, transparent 70%)'
            }} animate={{
              scale: [1, 1.1, 1],
              opacity: [0.3, 0.5, 0.3]
            }} transition={{
              ...
              height: '110px',
              borderRadius: '50%',
              background: 'linear-gradient(135deg, rgba(60, 180, 255, 0.2), rgba(60, 180, 255, 0.05))',
              display: 'flex',
              alignItems: 'center',
              justifyContent: 'center',
              margin: '0 auto 28px',
              border: '3px solid rgba(60, 180, 255, 0.3)',
              position: 'relative',
              zIndex: 2
            }} animate={{
              boxShadow: ['0 0 30px rgba(60, 180, 255, 0.3)', '0 0 60px rgba(60, 180, 255, 0.5)', '0 0 30px rgba(60, 180, 255, 0.3)']
            }} transition={{
              duration: 2,
              repeat: Infinity,
              ease: 'easeInOut'
                ...
                ease: 'easeInOut'
                  ...
                  <Download size={44} color="#3CB4FF" strokeWidth={2.5} />
                </motion.div>
              </motion.div>

    ...
    background: 'linear-gradient(180deg, #050B14 0%, #0A1929 50%, #050B14 100%)'
      ...
      zIndex: 10
        ...
        ease: 'easeOut'
          ...
          width: '200px',
          height: '200px',
          borderTop: '3px solid rgba(60, 180, 255, 0.3)',
          borderLeft: '3px solid rgba(60, 180, 255, 0.3)',
          ...
          width: '200px',
          height: '200px',
          borderBottom: '3px solid rgba(210, 20, 20, 0.3)',
          borderRight: '3px solid rgba(210, 20, 20, 0.3)',
          ...
          alignItems: 'stretch'
            ...
            delay: 0.2
              ...
              boxShadow: '0 0 20px rgba(60, 180, 255, 0.2), inset 0 0 10px rgba(210, 20, 20, 0.1)',
              marginBottom: '24px'
            }}>
                <Sparkles size={16} color="#D21414" />
                <span style={{
                fontSize: '13px',
                fontWeight: 600,
                color: '#3CB4FF',
              ...
              gap: '16px'
                ...
                x: 10,
                boxShadow: `-8px 0px 20px ${item.color}30, 8px 0px 20px ${item.color === '#3CB4FF' ? '#D21414' : '#3CB4FF'}30`
            ...
            delay: 0.4
              ...
              <motion.div style={{
              background: 'linear-gradient(135deg, rgba(60, 180, 255, 0.08) 0%, rgba(210, 20, 20, 0.05) 100%)',
              border: '2px solid rgba(60, 180, 255, 0.25)',
              borderRadius: '32px',
              padding: '50px 40px',
              textAlign: 'center',
              position: 'relative',
              ...
              boxShadow: '-15px 0px 40px rgba(60, 180, 255, 0.25), 15px 0px 40px rgba(210, 20, 20, 0.25)'
            }} transition={{
              duration: 0.3
            }}>
                ...
                zIndex: 2
                  ...
                  filter: 'drop-shadow(0 0 12px rgba(60, 180, 255, 0.5))',
                  stroke: 'url(#mainDownloadGradient)'
                }}>
                    <defs>
                      <linearGradient id="mainDownloadGradient" x1="0%" y1="0%" x2="100%" y2="100%">
                        <stop offset="0%" stopColor="#3CB4FF" />
                        <stop offset="100%" stopColor="#D21414" />
                      </linearGradient>
                    </defs>
                ...
                zIndex: 2
                  ...
                  delay: 0.6 + index * 0.1
                    ...
                    fontSize: '24px',
                    fontWeight: 800,
                    background: 'linear-gradient(135deg, #3CB4FF, #D21414)',
                    WebkitBackgroundClip: 'text',
                    WebkitTextFillColor: 'transparent',
                    backgroundClip: 'text',
                    marginBottom: '4px'
              ...
              <motion.div style={{
              background: 'linear-gradient(135deg, rgba(210, 20, 20, 0.08) 0%, rgba(60, 180, 255, 0.05) 100%)',
              border: '1px solid rgba(210, 20, 20, 0.2)',
              borderRadius: '24px',
              padding: '30px',
              marginTop: '24px',
              textAlign: 'center',
              ...
              delay: 0.7
                ...
                width: '100px',
                height: '100px',
                background: 'radial-gradient(circle, rgba(210, 20, 20, 0.15) 0%, transparent 70%)',
                borderRadius: '50%'
              }} />
                ...
                gap: '8px'
                  ...
                  <FileSignature size={24} color="#3CB4FF" />
                ...
                zIndex: 2
                  ...
                  width: '100%'
                    ...
                    fontSize: '15px',
                    fontWeight: 700,
                    background: 'linear-gradient(135deg, rgba(210, 20, 20, 0.1), rgba(60, 180, 255, 0.1))',
                    color: 'white',
                    border: '1px solid rgba(210, 20, 20, 0.4)',
                    cursor: 'pointer',
                    width: '100%',
                    boxShadow: '0 8px 30px rgba(210, 20, 20, 0.2)'
                  }} whileHover={{ transition: {
                      duration: 0.1,
                      delay: 0
                    },
                    scale: 1.02,
                    background: 'linear-gradient(135deg, rgba(210, 20, 20, 0.2), rgba(60, 180, 255, 0.2))',
                    boxShadow: '-10px 0px 30px rgba(210, 20, 20, 0.4), 10px 0px 30px rgba(60, 180, 255, 0.4)'
                  }} whileTap={{
                    scale: 0.98
                  }}>

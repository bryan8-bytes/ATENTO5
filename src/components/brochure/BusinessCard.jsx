...
END:VCARD`;
  ...
  return <motion.div style={{
    background: 'linear-gradient(135deg, rgba(60, 180, 255, 0.03), rgba(210, 20, 20, 0.03))',
    ...
    boxShadow: '-15px 0px 40px rgba(60, 180, 255, 0.25), 15px 0px 40px rgba(210, 20, 20, 0.25)'
      ...
      boxShadow: '0 0 20px rgba(60, 180, 255, 0.3), inset 0 0 10px rgba(210, 20, 20, 0.2)'
    }}>
      ...
      justifyContent: 'center'
        ...
        boxShadow: '-5px 0px 20px rgba(60, 180, 255, 0.4), 5px 0px 20px rgba(210, 20, 20, 0.4)'
      }} whileTap={{
        scale: 0.98
      }}>
          <Download size={18} color="#3CB4FF" />
          Guardar Contacto
        </motion.button>
      </div>
    </motion.div>;

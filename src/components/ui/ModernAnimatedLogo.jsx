    ...
    <div style={{ position: 'relative', display: 'inline-flex', flexDirection: 'column', alignItems: 'center' }}>
      ...
      {!disableRings && (
        ...
        style={{
          ...
          background: 'linear-gradient(45deg, rgba(60, 180, 255, 0.3), rgba(210, 20, 20, 0.3)) border-box',
      ...
      >
        ...
        <motion.div
          style={{
            ...
            height: '100%',
            borderRadius: '50%',
            background: 'radial-gradient(circle, rgba(60, 180, 255, 0.4) 0%, rgba(60, 180, 255, 0.1) 40%, transparent 70%)',
            filter: 'blur(20px)',
          }}
          animate={{
            scale: [1, 1.2, 1],
        ...
        <motion.img
          ...
          style={{
            ...
            position: 'relative',
            zIndex: 2,
            filter: 'drop-shadow(0 0 20px rgba(60, 180, 255, 0.6)) drop-shadow(0 0 40px rgba(60, 180, 255, 0.3))',
          }}
          animate={{
            rotateY: [0, 10, 0, -10, 0],
          }}
        ...
        {/* Sparkle Effects */}
        {[...Array(6)].map((_, i) => {
          const dotColor = variant === 'brochure' ? (i % 2 === 0 ? '#3CB4FF' : '#D21414') : '#3CB4FF';
        ...
        >
          <motion.h1
            style={{
              ...
              textShadow: 'none',
              lineHeight: 1,
              background: 'linear-gradient(90deg, #3CB4FF 0%, #D21414 50%, #3CB4FF 100%)',

...
const HERO_BUTTON_BASE =
  'group inline-flex items-center justify-center gap-3 text-center font-bold rounded-full text-lg md:text-xl min-h-[64px] py-5 md:py-6 px-12 md:px-16 min-w-[240px] md:min-w-[300px] transition-all duration-300'

const HERO_BUTTONS_CONTAINER_CLASSES =
  'relative top-16 md:top-20 lg:top-24 flex flex-col sm:flex-row gap-4 md:gap-5 mt-24 md:mt-28 w-full justify-start items-stretch sm:items-center'
...
const HeroSlider = () => {
  ...
  return (
    <section
      id="hero"
      className="relative min-h-screen overflow-x-hidden flex items-center justify-center py-16 md:py-24 lg:py-0 select-none"
    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 w-full">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-14 xl:gap-20 items-center">
            ...
            <AnimatePresence mode="wait" custom={direction}>
              ...
              >
                <Motion.div
                  ...
                  animate="visible"
                  exit="exit"
                  className="inline-flex items-center gap-3 px-5 py-2 md:px-6 md:py-2.5 rounded-full border border-white/10 bg-white/5 backdrop-blur-md mb-5 md:mb-7 lg:mb-8 hover:border-white/25 transition-all duration-300"
                  style={{ color: slide.accent, boxShadow: `0 4px 20px ${slide.accent}08` }}
                >
                ...
                <Motion.h1
                  ...
                  animate="visible"
                  exit="exit"
                  className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-black mb-5 md:mb-7 lg:mb-8 leading-[1.08] tracking-tight"
                >
                ...
                <Motion.h2
                  ...
                  animate="visible"
                  exit="exit"
                  className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-extrabold mb-6 md:mb-8 lg:mb-9 tracking-wide leading-snug"
                  style={{
                ...
                <Motion.p
                  ...
                  animate="visible"
                  exit="exit"
                  className="text-base sm:text-lg md:text-xl mb-4 md:mb-5 lg:mb-6 leading-relaxed font-light text-white/70 max-w-xl"
                >
                  {slide.description}
                </Motion.p>
                ...
                {slide.showSocials && (
                  <>
                    ...
                    <Motion.div
                      ...
                      animate="visible"
                      exit="exit"
                      className="flex flex-wrap items-center gap-4 mb-4 md:mb-5 lg:mb-6"
                    >
          ...
          >
              <Motion.div
                className="relative w-full aspect-square max-w-[220px] sm:max-w-xs md:max-w-md lg:max-w-lg mx-auto"
                animate={{ y: [0, -12, 0] }}
      ...
      <div className="absolute bottom-6 left-1/2 -translate-x-1/2 flex items-center gap-3 z-30">
        {slides.map((s, index) => (
          <Motion.button
            ...
            style={{
              width: current === index ? '84px' : '18px',
              backgroundColor: current === index ? `${s.accent}18` : 'rgba(255, 255, 255, 0.12)',
              border: current === index ? `1px solid ${s.accent}60` : '1px solid rgba(255, 255, 255, 0.06)',
              boxShadow: current === index
                ? `0 0 0 1px ${s.accent}30, 0 10px 20px ${s.accent}25`
                : 'inset 0 1px 0 rgba(255,255,255,0.12)',
              transition: 'width 0.55s cubic-bezier(0.22, 1, 0.36, 1), background-color 0.35s ease, border-color 0.35s ease, box-shadow 0.35s ease',
            }}
            ...
            {current === index && (
              <Motion.div
                ...
                style={{
                  ...
                  boxShadow: `0 0 18px ${s.accent}70`,

  ...
  return (
    <section style={{
      ...
      <div style={{
        position: 'absolute',
        inset: 0,
        background: 'radial-gradient(ellipse at 50% 40%, rgba(60, 180, 255,0.08) 0%, rgba(5,11,20,0.95) 70%)',
      }} />
          ...
          <div style={{ display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center', marginTop: '24px' }}>
            ...
            <motion.h1 
              style={{
                ...
                backgroundClip: 'text',
                textShadow: '0 0 30px rgba(60, 180, 255,0.2)',
              }}
            >
              ATENTO5
            </motion.h1>
        ...
        >
          <motion.button
            ...
            style={{
              ...
              fontWeight: 700,
              fontSize: '17px',
              background: 'linear-gradient(135deg, rgba(60, 180, 255,0.15) 0%, rgba(210, 20, 20,0.15) 100%)',
              color: 'white',
              border: '1.5px solid rgba(60, 180, 255,0.4)',
              cursor: 'pointer',
              boxShadow: '0 0 20px rgba(60, 180, 255, 0.2)',
              backdropFilter: 'blur(10px)',
            }}
            whileHover={{ transition: { duration: 0.1, delay: 0 }, scale: 1.05, 
              borderColor: 'rgba(210, 20, 20,0.8)',
              background: 'linear-gradient(135deg, rgba(60, 180, 255,0.25) 0%, rgba(210, 20, 20,0.25) 100%)',
              boxShadow: '-10px 0 25px rgba(60, 180, 255, 0.4), 10px 0 25px rgba(210, 20, 20, 0.4)'
            }}
            whileTap={{ scale: 0.95 }}
          >
            <motion.span
              ...
              animate={{
                ...
                boxShadow: ['0 0 8px #3CB4FF', '0 0 8px #D21414', '0 0 8px #3CB4FF'],
              }}
        ...
        >
          ...
          <motion.div
            style={{
              ...
              height: '8px',
              borderRadius: '2px',
              background: 'linear-gradient(180deg, #3CB4FF, #D21414)',
